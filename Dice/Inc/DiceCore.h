...
#ifndef SILENTDICE
#define DICEBOOTLOADERSIZE          (0x00020000)
#else
#define DICEBOOTLOADERSIZE          (0x00009400)
#endif
#define DICEDATASTART               (0x0807f800)
#define DICEDATASIZE                (0x00000800)
#define DICERAMSTART                (0x10000000)
#define DICERAMSIZE                 (0x00008000)
#define DICEFLASHSTART              (0x08000000)
#define DICEFLASHSIZE               (0x0007f800)

#define DICEFUSEDATASIZE            (0x800)
...
#define DICEFUSEAREA                ((PDicePersistedData_t)DICEDATASTART)
//#define DICEREQUESTAREA             ((PDicePersistedData_t)(DICEDATASTART + DICEFUSEDATASIZE))
